...
<?php }elseif ($_SESSION['statusCustomer'] == 'login') {  ?>
	...
	<div class="belanja mt-4">
		<p>1. Register jika belum punya akun</p>
    	<p>2. Login dengan akun yang telah dibuat</p>
    	<p>3. Pilih produk yang diinginkan</p>
    	<p>4. Pilih detail produk</p>
    	<p>5. Pilih kurir</p>
    	<p>6. Jika barang sudah sampai segera lakukan pembayaran sesuai total harga</p>
    	<p>7. Selesai</p>
	</div>
